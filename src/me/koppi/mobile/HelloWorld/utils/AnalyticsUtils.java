...
package me.koppi.mobile.HelloWorld.utils;
...
public class AnalyticsUtils {
    ...
    private static final String UACODE = "UA-6983984-3";
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "HelloWorld Analytics trackEvent: "
                            + category + " / " + action + " / " + label + " / " + value);
                } catch (Exception e) {
                    // We don't want to crash if there's an Analytics library exception.
                    Log.w(TAG, "HelloWorld Analytics trackEvent error: "
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "HelloWorld Analytics trackPageView: " + path);
                } catch (Exception e) {
                    // We don't want to crash if there's an Analytics library exception.
                    Log.w(TAG, "HelloWorld Analytics trackPageView error: " + path, e);
                }
                return null;
            }
        }.execute();
